    ...
    $cnxn = @mysqli_connect($hostname, $username, $password, $database) 
        or die ("Error connecting to database: " .
                mysqli_connect_error());
                            ...
                            $sql = "INSERT INTO sample (hive_id, collection_date, sample_period, mite_count, Submit_timestamp) VALUES('" . $_POST['id'] . "', '" . mysql_escape_string($_POST['date']) . "', '" . $_POST['period'] . "', '" . $_POST['count'] . "', NOW())";
